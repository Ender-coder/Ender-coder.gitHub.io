...
`;
    ...
    const codeCopyInit = () => {
        ...
        clipboard.on('success', (e) => {
            ...
            e.trigger.innerHTML = `<i class="fas fa-check-circle"></i>&nbsp;复制成功~`;
            setTimeout(() => {
